...
The regression gate combines fast Node unit tests with Playwright tests against the real browser UI. It covers themes and persistence, the 2D canvas palette, collapsed/searchable component menus, selected-component controls, direct-file launch guidance, 3D theme isolation, and the STL assets involved in the Trident/Octopus loading regression.
